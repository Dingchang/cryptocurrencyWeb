defmodule CryptoTrackerWeb.NotificationControllerTest do
  use CryptoTrackerWeb.ConnCase

  alias CryptoTracker.Track

  @create_attrs %{above: true, currency: "some currency", threshold: "120.5"}
  ...
  def fixture(:notification) do
    {:ok, notification} = Track.create_notification(@create_attrs)
    notification
  end
